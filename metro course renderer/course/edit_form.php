...
class course_edit_form extends moodleform {
    ...
    function definition() {
        ...
        // addng disabled so that nobody changes the date here . it can only be changed via manage content 30 apr 2017 Mihir
		$mform->addElement('date_selector', 'enddate', get_string('enddate'), array('optional' => true), array('disabled'=>'disabled'));
