 ...
 $i = 1;
				...
				//28th april check if at all any course is selected
				if ($getcourses != '') {
?>
 <div id="myCarousel" class="carousel slide" data-ride="carousel">
   		 <!-- Wrapper for slides -->
				...
				echo '<div class="carousel-inner" role="listbox">
						...
						//echo '<img src="'.$imglink.'" width="210" height="175">';
