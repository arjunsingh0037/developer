...
<?php if($PAGE->theme->settings->font_body == 21 || $PAGE->theme->settings->font_heading == 27) { ?>
<style type="text/css">
	@font-face {
	font-family:'proximanova_regular';
	src:url('<?php echo $CFG->wwwroot ?>/theme/lambda/fonts/proximanova-regular.eot');
	src:url('<?php echo $CFG->wwwroot ?>/theme/lambda/fonts/proximanova-regular.eot?#iefix') format('embedded-opentype'),url('<?php echo $CFG->wwwroot ?>/theme/lambda/fonts/proximanova-regular.woff') format('woff'),url('<?php echo $CFG->wwwroot ?>/theme/lambda/fonts/proximanova-regular.ttf') format('truetype'),url('<?php echo $CFG->wwwroot ?>/theme/lambda/fonts/proximanova-regular.svg#proximanova_regular') format('svg');
	font-weight:normal;
	font-style:normal;
	}
	@font-face {
	font-family:'proximanova_bold';
	src:url('<?php echo $CFG->wwwroot ?>/theme/lambda/fonts/proximanova-bold.eot');
	src:url('<?php echo $CFG->wwwroot ?>/theme/lambda/fonts/proximanova-bold.eot?#iefix') format('embedded-opentype'),url('<?php echo $CFG->wwwroot ?>/theme/lambda/fonts/proximanova-bold.woff') format('woff'),url('<?php echo $CFG->wwwroot ?>/theme/lambda/fonts/proximanova-bold.ttf') format('truetype'),url('<?php echo $CFG->wwwroot ?>/theme/lambda/fonts/proximanova-bold.svg#proximanova_bold') format('svg');
	font-weight:normal;
	font-style:normal;
	}
</style>
