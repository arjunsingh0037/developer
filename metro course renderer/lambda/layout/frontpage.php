...
<?php require_once(dirname(__FILE__).'/includes/slideshow.php');?>
    ...
    <div id="page-content" class="row-fluid">
        ...
        <?php } ?>
         <?php require_once('includes/slidercourse.php'); ?>
            ...
            if ($hasfrontpageblocks==1) { 
                if ($standardlayout) {echo $OUTPUT->blocks('side-pre', 'span3 desktop-first-column pull-left');}
                else {echo $OUTPUT->blocks('side-pre', 'span3 desktop-first-column pull-right');}
            } ?>
            </div>
            </div>
...
<![endif]-->
<script src="<?php echo $CFG->wwwroot;?>/theme/lambda/jquery/transition.js"></script>
<script src="<?php echo $CFG->wwwroot;?>/theme/lambda/jquery/bootstrap-carousel.js"></script>
<script>
	jQuery(document).ready(function(){
		$(function(){
			//$('#myCarousel').carousel('slide',{interval: 3000, cycle: true,});
			$('.carousel').carousel({interval: 6000, cycle: true,});
