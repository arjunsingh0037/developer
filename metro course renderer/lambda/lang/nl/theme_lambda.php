...
/* Theme */
$string['visibleadminonly'] ='Blokken verplaatst naar het gebied onder zal alleen worden gezien door admins';
...
$string['enrlist'] = 'Lijst van Inschrijving';
$string['metrotrainings'] = 'Trainingen';
$string['metromeetings'] = 'Vergaderingen';
$string['metrocompleted'] = 'Afgerond';
$string['metrobadges'] = 'Recente Onderscheidingen';
$string['viewall'] = 'Bekijk alles';
$string['ccategorylist'] = 'categorie lijst';
$string['cviewcourselist'] = 'Bekijk Cursus Listing';
/* 23rd august */
