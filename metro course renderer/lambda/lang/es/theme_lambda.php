...
<p>Compatibilidad: Moodle 2.5/2.6/2.7/2.8/2.9<br />Versi&oacute;n del tema: 1.42<br />Tema matriz: Bootstrapbase de Bas Brands<br />Basado en: Essential de Julian Ridden</p>
</div>
<hr />
...
/* login page*/
$string['switchacademy'] = 'cambiar Academia';
$string['academy'] = 'Select Your Academy';
$string['logintext'] = 'Sign in for ';
$string['academy_small'] = 'Select Your academy';
$string['loginfootertext'] = 'Este sistema de intranet esta solamente para el personal encargado de la aplicacion de la ley. Este sistema informatico, incluyendo todo el equipo relacionado,  las redes y el sistema de gestion de aprendizaje, se proporcionan solamente para el uso autorizado. El CBSI Connect y la red pueden ser monitoreados para fines legales; incluyendo, asegurar que el uso esta autorizado, para la gestion del sistema, para facilitar la proteccion contra el acceso no autorizado, y para verificar los procedimientos de la seguridad y la seguridad operacional. La informacion recogida por el monitoreo, puede ser examinada, grabada, copiada y utilizada con fines autorizados. Toda la informacion, incluyendo la informacion personal, colocada o enviada sobre este sistema puede ser monitoreada. El uso de este sistema informatico, autorizado o no autorizado, constituye el consentimiento a la supervision de este sistema. El uso no autorizado puede exponerte a enjuiciamiento criminal. Evidencia del uso no autorizado, recogida por el monitoreo del sistema, puede ser usada para la accion administrativa, penal u otra. Acceder al sistema es aceptar estos terminos y condiciones. ';
$string['loginfooterhead'] = 'Caribbean Police Academy Regional Training Initiative';
$string['loginfooterhelp'] = 'CBSI-Connect Help';
$string['logindnpname'] = 'República Dominicana - Policia Nacional Dominicana';
$string['logindncdname'] = 'República Dominicana - National Drugs Control Agency';


/* for metro translation */
$string['logintext'] = 'Sign in for';
$string['enrlist'] = 'Listado de Cursos';
$string['metrotrainings'] = 'Capacitaciones';
$string['metromeetings'] = 'Reuniones';
$string['metrocompleted'] = 'Finalizados';
$string['metrobadges'] = 'Insignias';
$string['viewall'] = 'Ver todo';
$string['ccategorylist'] = 'Listado de Categorías';
$string['cviewcourselist'] = 'Listado de Capacitaciones';
/* 23rd august */
$string['ccategory'] = 'Category : ';
$string['cenrolled'] = 'Enrolled';
$string['cenrstart'] = 'Start Date : ';
$string['cenrend'] = 'End Date : ';
$string['csummary'] = 'Summary';
$string['cinstructor'] = 'Instructor : ';
$string['ccontinue'] = 'Continuar';

//Metro extra lang gender 22nd sept
$string['gendermandatory'] = 'Gender field is mandatory';

//acad login 14th march 2017
$string['acad_loginmsg'] = 'Usted será redirigido a su academia. Por favor,  ingrese con su Nombre de Usuario y Contraseña. Los Entrenamientos compartidos, Tutoriales y Calendario de actividades todavía están disponibles en CBSI-Connect.';
$string['switchconfirm'] = 'Presione continuar para ir a su Academia';

//acad forgot pass 26 may 2017
$string['academyforgot'] = 'Seleccione su academia con el boton Academy Links. Si no esta afiliado a ninguna academia, por favor ingrese su nombre de usuario o correo electronico en las casillas.';