...
<p>Compatibility: Moodle 2.5/2.6/2.7/2.8/2.9<br />Theme Version: 1.42<br />Parent theme: Bootstrapbase by Bas Brands<br />Built on: Essential by Julian Ridden</p>
</div>
<hr />
...
/* Settings - Courses */
$string['carousel_courses'] = 'Select courses';
$string['carousel_coursesdesc'] = 'Choose courses to be displayed in frontpage slider.';
$string['settings_courses'] = 'Slider Courses';
...
$string['backtotop'] = '';
/* login page -- added by arjun*/
$string['switchacademy'] = 'Switch Academy';
$string['academy'] = 'Select Your Academy';
$string['academy_small'] = 'Select Your academy';
$string['loginfootertext'] = 'This is an intranet system intended for law enforcement personnel only. This computer system, including all related equipment, networks, and the learning management system are provided only for authorized use. CBSI Connect and Intranet may be monitored for all lawful purposes; including, to ensure that use is authorized, for management of the system, to facilitate protection against unauthorized access, and to verify security procedures and operational security. During monitoring, information may be examined, recorded, copied and used for authorized purposes. All information, including personal information, placed or sent over this system may be monitored. Use of this computer system, authorized or unauthorized, constitutes consent to monitoring by this system. Unauthorized use may subject you to criminal prosecution. Evidence of unauthorized use collected during monitoring may be used for administrative, criminal, or other action. By loging into this system you are accepting these terms and conditions.';
...
$string['logintext'] = 'Log in to';
$string['enrlist'] = 'Enrollment List';
$string['metrotrainings'] = 'Trainings';
$string['metromeetings'] = 'Meetings';
$string['metrocompleted'] = 'Completed';
$string['metrobadges'] = 'Latest Badges';
$string['viewall'] = 'View all';
$string['ccategorylist'] = 'Category Listing';
$string['cviewcourselist'] = 'View Course Listing';
/* 23rd august */
...
$string['acad_loginmsg'] = 'You will be directed to your academy website. Please sign in with your username and password. Shared content, Tutorials and Global Calendar are still available on the CBSI-Connect.';
$string['switchconfirm'] = 'Press continue to be directed to your academy';

//acad forgot pass 26 may 2017
$string['academyforgot'] = 'Please select your academy from the Academy Links button below. If you have no academy affiliation, please enter your username or email below';